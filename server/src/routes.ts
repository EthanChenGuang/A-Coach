...
import { WorkoutData, MealPlanData, WorkoutScheduleData, MealScheduleData } from './db';
import { workoutScheduleHandlers } from 'handlers/workout-schedules';
import { mealScheduleHandlers } from 'handlers/meal-schedules';
...
export const routes: (Route<any>)[] = [
  ...
  } as Route<MealPlanData>,
  {
    ...
    handler: mealScheduleHandlers
  } as Route<MealScheduleData>,
  {
